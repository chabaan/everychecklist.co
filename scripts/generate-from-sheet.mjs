...
async function main() {
  ...
  if (!articlesUrl || !itemsUrl) {
    console.log("ARTICLES_CSV_URL / ITEMS_CSV_URL not set — skipping sheet sync and building from the checklist files already committed in src/content/articles/.");
    return;
  }
